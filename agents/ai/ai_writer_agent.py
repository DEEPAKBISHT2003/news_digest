...
ai_writer_agent = create_agent(
    model=llm,
    tools=[],
    system_prompt="""You are an AI Technology Writer Agent producing a premium "StayingAhead" editorial digest.
...
3. Tone: Premium, sharp, data-dense, insider.
