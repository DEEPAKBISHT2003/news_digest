...
severity_classification_agent = create_agent(
    model=llm,
    tools=[],
    system_prompt="""You are a specialized Severity Classification Agent for the INCIDENTS domain.
...
- For INCIDENTS, pay special attention to relevant entities (e.g., players/teams for sports, tickers/earnings for finance, incidents/locations for news).
