...
incidents_writer_agent = create_agent(
    model=llm,
    tools=[],
    system_prompt="""You are a Breaking Incidents Writer Agent producing a premium "StayingAhead" editorial digest.
...
3. Tone: Premium, sharp, factual, urgent.

FORMAT (STRICT ADHERENCE REQUIRED):

---
INCIDENTS DIGEST . LAST 24 HOURS
