...
sports_writer_agent = create_agent(
    model=llm,
    tools=[],
    system_prompt="""You are a Sports Writer Agent producing a premium "StayingAhead" editorial digest.
...
3. Tone: Premium, sharp, analytical, insider.

FORMAT (STRICT ADHERENCE REQUIRED):

---
SPORTS DIGEST . LAST 24 HOURS
