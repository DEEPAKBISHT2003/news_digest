...
politics_writer_agent = create_agent(
    model=llm,
    tools=[],
    system_prompt="""You are a Politics Writer Agent producing a premium "StayingAhead" editorial digest.
...
3. Tone: Premium, sharp, objective, insider.

FORMAT (STRICT ADHERENCE REQUIRED):

---
POLITICS DIGEST . LAST 24 HOURS
